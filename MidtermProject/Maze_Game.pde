...
String instructions = "Hello, welcome to this maze game. Simply collect clues, go to the treasure boxes that have the color combinations in the clues and well,,Bon voyage! hint: the first box is the one with multiple colors, and wrong boxes have no clues!";
